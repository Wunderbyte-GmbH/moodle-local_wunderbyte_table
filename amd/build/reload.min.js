define("local_wunderbyte_table/reload",["exports","local_wunderbyte_table/init","local_wunderbyte_table/filter","local_wunderbyte_table/search","local_wunderbyte_table/sort"],(function(_exports,_init,_filter,_search,_sort){function wbTableReload(idstringplusa,encodedtable){let rowid=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0;const idstring=idstringplusa.substring(1);let filterobjects=(0,_filter.getFilterObjects)(idstring);if(rowid>0){let filterobject={};0!==filterobjects.length&&(filterobject=JSON.parse(filterobjects)),filterobject.id=[rowid],filterobjects=JSON.stringify(filterobject)}const replacerow=rowid>0,searchstring=(0,_search.getSearchInput)(idstring),sort=(0,_sort.getSortSelection)(idstring);(0,_init.callLoadData)(idstring,encodedtable,0,null,sort,null,null,null,filterobjects,searchstring,replacerow)}Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.expiredReloadAllowed=function(){try{const lastreload=parseInt(sessionStorage.getItem("wbtable_expiredreload")??"0",10);return!(Date.now()-lastreload<6e4)&&(sessionStorage.setItem("wbtable_expiredreload",String(Date.now())),!0)}catch(e){return!1}},_exports.initializeReload=
/**
