...
/*
   ...
   */
function(listContainer,idstring,encodedtable){console.log("soinitializeSortrt called ",listContainer);const container=document.querySelector(listContainer),sortColumnElement=container.querySelector("select.sortcolumn"),sortOrderElement=container.querySelector("a.changesortorder");if(!sortColumnElement||!sortOrderElement)return void console.log("abort ",sortColumnElement,sortOrderElement.className);sortColumnElement.dataset.initialized&&sortOrderElement.dataset.initialized||(sortColumnElement.dataset.initialized=!0,sortOrderElement.dataset.initialized=!0,sortColumnElement.addEventListener("change",(e=>{callSortAjax(e,idstring,encodedtable)})),sortOrderElement.addEventListener("click",(()=>{callSortAjax(null,idstring,encodedtable)})))}}));
