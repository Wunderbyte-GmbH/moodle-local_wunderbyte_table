 ...
 */
final class datepickerspan_test extends TestCase {
    /**
     * Test get_operatoroptions_name() method.
     * @covers \local_wunderbyte_table\filters\types\datepickerspan::get_operatoroptions_name
     *
     */
    public function test_get_operatoroptions_name(): void {
        ...
        $result = datepickerspan::get_operatoroptions_name($selectedoptions);
        $this->assertSame($expected, $result);
    }

    /**
     * Test get_operatoroptions_index() method.
     * @covers \local_wunderbyte_table\filters\types\datepickerspan::get_operatoroptions_index
     */
    public function test_get_operatoroptions_index(): void {
        $selectedoptions = ['within', 'overlapstart'];
        $expected = [0, 2];

        $result = datepickerspan::get_operatoroptions_index($selectedoptions);
        $this->assertSame($expected, $result);
    }

    /**
     * Test get_timestamp() method.
     * @covers \local_wunderbyte_table\filters\types\datepickerspan::get_timestamp
     */
    public function test_get_timestamp(): void {
        $input = ['day' => 10, 'month' => 3, 'year' => 2025];
        $expected = mktime(0, 0, 0, 3, 10, 2025);

        $result = datepickerspan::get_timestamp($input);
        $this->assertSame($expected, $result);
    }

    /**
     * Test get_moodle_form_date() method.
     * @covers \local_wunderbyte_table\filters\types\datepickerspan::get_moodle_form_date
     */
    public function test_get_moodle_form_date(): void {
        $timestamp = mktime(0, 0, 0, 3, 10, 2025);
        $expected = ['day' => 10, 'month' => 3, 'year' => 2025];

        $result = datepickerspan::get_moodle_form_date($timestamp);
        $this->assertSame($expected, $result);
    }

    /**
     * Test validate_input() method.
     * @covers \local_wunderbyte_table\filters\types\datepickerspan::validate_input
     */
    public function test_validate_input(): void {
        ...
        $result = datepickerspan::validate_input($validdata);
        ...
        $result = datepickerspan::validate_input($invaliddata);
     ...
     * @covers \local_wunderbyte_table\filters\types\datepickerspan::get_new_filter_values
     */
    public function test_get_new_filter_values(): void {
        ...
        $result = datepickerspan::get_new_filter_values($data, 'testcolumn');
        $this->assertEquals($expected, $result);
    }

    /**
     * Test render_mandatory_fields() method.
     * @covers \local_wunderbyte_table\filters\types\datepickerspan::render_mandatory_fields
     * @covers \local_wunderbyte_table\filters\types\datepickerspan::add_date_filter_head
     * @covers \local_wunderbyte_table\filters\types\datepickerspan::set_date_filter_input
     * @covers \local_wunderbyte_table\filters\types\datepickerspan::set_date_default_value_input
     */
    public function test_render_mandatory_fields(): void {
        ...
        datepickerspan::render_mandatory_fields($mformmock, $data);
    }
}
