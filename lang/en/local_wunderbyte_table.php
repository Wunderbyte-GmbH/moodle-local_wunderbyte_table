...
$string['filteractivecount'] = '{$a} filter(s) active';
...
$string['filtersearchlabel'] = 'Search in filter {$a}';
...
$string['privacy:metadata:local_wunderbyte_table:sqlquery'] = 'SQL query the cache key hash is built from';
...
$string['selectallfromcategory'] = 'Select all from {$a}';
$string['selectedtimespan'] = 'selected timespan';
$string['selectoptionforrow'] = 'Select an option for row {$a}';
$string['selectrow'] = 'Select row {$a}';
...
$string['subitemsof'] = 'Sub-items of {$a}';
...
$string['textinputforrow'] = 'Text input for row {$a}';
$string['textinputplaceholder'] = 'Enter some text';
