...
$string['filteractivecount'] = '{$a} Filter aktiv';
...
$string['filtersearchlabel'] = 'Im Filter {$a} suchen';
...
$string['selectallfromcategory'] = 'Alle aus {$a} auswählen';
$string['selectedtimespan'] = 'gewählter Zeitspanne';
$string['selectoptionforrow'] = 'Option für Zeile {$a} auswählen';
$string['selectrow'] = 'Zeile {$a} auswählen';
...
$string['subitemsof'] = 'Untereinträge von {$a}';
...
$string['textinputforrow'] = 'Texteingabe für Zeile {$a}';
$string['textinputplaceholder'] = 'Text eingeben';
